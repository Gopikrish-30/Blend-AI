...
def set_object_transform(ctx: Context, name: str, location: list = None, rotation: list = None, scale=None, user_prompt: str = "") -> str:
    """
...
def create_primitive(ctx: Context, primitive_type: str, name: str = None, location: list = None, scale=None, user_prompt: str = "") -> str:
    """
...
def duplicate_object(ctx: Context, name: str, new_name: str = None, location_offset: list = None, linked: bool = False, user_prompt: str = "") -> str:
    """
...
def set_object_visibility(ctx: Context, name: str, hide: bool = False, hide_render: bool = None, user_prompt: str = "") -> str:
    """
...
def create_collection(ctx: Context, name: str, parent_collection: str = None, user_prompt: str = "") -> str:
    """
...
def create_material(ctx: Context, name: str, base_color: list = None, roughness: float = 0.5, metallic: float = 0.0, alpha: float = 1.0, user_prompt: str = "") -> str:
    """
...
def set_world_hdri(ctx: Context, hdri_path: str = None, strength: float = 1.0, color: list = None, user_prompt: str = "") -> str:
    """
...
def create_light(ctx: Context, light_type: str, name: str = None, location: list = None, energy: float = 10.0, color: list = None, radius: float = 0.25, user_prompt: str = "") -> str:
    """
...
def set_light_property(ctx: Context, name: str, energy: float = None, color: list = None, radius: float = None, angle: float = None, user_prompt: str = "") -> str:
    """
...
def create_camera(ctx: Context, name: str = None, location: list = None, rotation: list = None, focal_length: float = 50.0, user_prompt: str = "") -> str:
    """
...
def set_camera_property(ctx: Context, name: str, focal_length: float = None, sensor_width: float = None, dof_distance: float = None, dof_enabled: bool = None, user_prompt: str = "") -> str:
    """
...
def frame_objects(ctx: Context, names: list = None, user_prompt: str = "") -> str:
    """
...
def add_modifier(ctx: Context, object_name: str, modifier_type: str, name: str = None, user_prompt: str = "", **kwargs) -> str:
    """
...
def set_render_settings(ctx: Context, engine: str = None, resolution_x: int = None, resolution_y: int = None, samples: int = None, film_transparent: bool = None, user_prompt: str = "") -> str:
    """
...
def check_object_placement(ctx: Context, names: list = None, user_prompt: str = "") -> str:
    """
...
def list_objects_by_type(ctx: Context, obj_type: str = None, user_prompt: str = "") -> str:
    """
