export enum IpcChannel {
  ...
  // Blender connection monitor (BlenderConnectionService)
  /** Renderer → Main: get current connection status */
  Blender_GetConnectionStatus = 'blender:get-connection-status',
  /** Main → Renderer push: connection status changed */
  Blender_ConnectionStatusChanged = 'blender:connection-status-changed',
  /** Renderer → Main: force an immediate re-check */
  Blender_CheckConnection = 'blender:check-connection',
  /** Renderer → Main: execute a TCP command on the Blender socket */
  Blender_ExecuteCommand = 'blender:execute-command'
