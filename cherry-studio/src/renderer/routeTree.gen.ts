...
import { Route as AppBlenderRouteImport } from './routes/app/blender'
...
const AppBlenderRoute = AppBlenderRouteImport.update({
  id: '/blender',
  path: '/blender',
  getParentRoute: () => AppRoute,
} as any)
...
export interface FileRoutesByFullPath {
  ...
  '/app/blender': typeof AppBlenderRoute
...
declare module '@tanstack/react-router' {
  interface FileRoutesByPath {
    ...
    '/app/blender': {
      id: '/app/blender'
      path: '/blender'
      fullPath: '/app/blender'
      preLoaderRoute: typeof AppBlenderRouteImport
      parentRoute: typeof AppRoute
    }
    '/app/agents': {
      id: '/app/agents'
...
interface AppRouteChildren {
  ...
  AppBlenderRoute: typeof AppBlenderRoute
...
const AppRouteChildren: AppRouteChildren = {
  ...
  AppBlenderRoute: AppBlenderRoute,
